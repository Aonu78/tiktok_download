...
export default {
  home: {
    ...
    title: 'TikTok Video Download With 1 Click',
    languages: 'english',
    ...
    clear: 'clear',
    download: 'download',
    text1: 'TikTok Video Download With 1 Click',
    text2:
      'My-Tik-Taki.com là một trình tải video tiktok, không logo, không watermark. Bạn chỉ cần dán link video tiktok cần tải. Tuy nhiên, bạn nên cẩn trọng và có được sự cho phép trước khi tải xuống video tiktok. Sử dụng các trình tải xuống như vậy có thể vi phạm các điều khoản dịch vụ của TikTok.',
    text3:
      'Bạn không cần phải cài đặt bất kì phần mềm nào trên máy tính hoặc điện thoại di động của mình. Tất cả những gì bạn cần là một đường link đến video tiktok và toàn bộ quá trình xử lý được thực hiện trên phía của My-Tik-Taki. Với một cú nhấp chuột video của bạn sẽ được tải về thiết bị của mình.',
    text4: 'Chức năng chính',
    feature1:
      'Tải xuống video tiktok không có logo, không watermark: My-Tik-Taki.com cho phép bạn tải xuống video tiktok không logo, không watermark, giúp bạn dễ dàng lưu trữ và chia sẻ video của mình.',
    feature2:
      'Giao diện thân thiện với người dùng: My-Tik-Taki.com có giao diện đơn giản và trực quan giúp người dùng dễ sử dụng, ngay cả đối với những người không rành về công nghệ.',
    feature3:
      'Không cần phần mềm bổ sung: My-Tik-Taki.com là ứng dụng trực tuyến, nghĩa là bạn không cần phải cài đặt bất kỳ phần mềm bổ sung nào trên máy tính hoặc điện thoại di động của mình.',
    feature4:
      'Nhanh chóng và hiệu quả: My-Tik-Taki.com được thiết kế để xử lý và tải xuống video nhanh chóng, giúp bạn tiết kiệm thời gian và có được những video TikTok yêu thích của mình chỉ một cú nhấp chuột.',
    feature5:
      'Miễn phí vĩnh viễn: My-Tik-Taki.com hoàn toàn miễn phí sử dụng và không có bất kỳ khoản phí hoặc chi phí ẩn nào. Bạn có thể tải xuống bao nhiêu video tiktok mà bạn muốn, không có bất kỳ hạn chế nào.',
    note: 'Note:',
    noteContent:
      'My-Tik-Taki là một nền tảng độc lập và không có liên kết với Tiktok hoặc ByteDance Ltd. Nền tảng của chúng tôi được thiết kế để cung cấp một cách thức không phức tạp để người dùng Tiktok có thể tải xuống video tiktok mà không có logo, watermark. Chúng tôi cam kết cung cấp trải nghiệm người dùng tốt nhất và luôn cập nhật dịch vụ của mình để đảm bảo tải xuống dễ dàng và hiệu quả. Nếu bạn đã gặp vấn đề với các trang web khác như Tikmate, SnapTik hoặc SSSTiktok, hãy thử My-Tik-Taki của chúng tôi. Nền tảng của chúng tôi luôn miễn phí để sử dụng và chúng tôi dựa vào quảng cáo để hỗ trợ bảo trì và phát triển dịch vụ của mình. Cảm ơn bạn đã lựa chọn My-Tik-Taki để tải xuống video tiktok của bạn.',
    contact: 'contact',
  ...
  meta: {
    title: 'TikTok Video Download With 1 Click',
    itemprop: 'TikTok Video Download With 1 Click',
    description:
    ...
    twitterTitle: 'TikTok Video Download With 1 Click',
    twitterDescription:
      'Công cụ tải video tiktok không có logo, hình mờ, watermark hoàn toàn miễn phí. Hỗ trợ mọi thiết bị như điện thoại Android, Iphone... Tiktok video without watermark.',
    ogTitle: 'TikTok Video Download With 1 Click',
    ogDescription:
      'Công cụ tải video tiktok không có logo, hình mờ, watermark hoàn toàn miễn phí. Hỗ trợ mọi thiết bị như điện thoại Android, Iphone... Tiktok video without watermark.',
  ...
  contact: {
    short: 'Contact',
    title: 'contact - TikTok Video Download With 1 Click',
    description1: 'Để contact với My-Tik-Taki.com, bạn vui lòng gởi mail đến ',
    description2:
  ...
  privacy: {
    ...
    title:
      'privacy-policy chỉ English - TikTok Downloader - Download Video tiktok Without Watermark - My-Tik-Taki',
  ...
  terms: {
    ...
    title:
      'terms-of-services chỉ English - TikTok Downloader - Download Video tiktok Without Watermark - My-Tik-Taki',
  ...
  errors: {
    HAVE_ERROR: "Xin lỗi, chúng tôi đã gặp sự cố. Vui lòng thử lại sau. Cảm ơn bạn đã kiên nhẫn.'",
    NOT_A_LINK_TIKTOK:
      'Xin lỗi, link được cung cấp không phải là link TikTok hợp lệ. Vui lòng cung cấp một link TikTok hợp lệ để tiếp tục.',
  },
  form: {
    placeholder: 'Dán liên kết video của bản vào đây',
  },
  questions: {
    q1: 'Làm cách nào để tải xuống video tiktok không có watermark?',
    ...
    a16: 'Quay trở lại My-Tik-Taki.com và dán liên kết đến video tiktok của bạn vào trường ở trên, sau đó nhấp vào Nút Download.',
    a17: 'Đợi máy chủ của chúng tôi thực hiện công việc của mình và sau đó lưu video vào thiết bị của bạn tự động.',
    q2: 'Làm cách nào để có được liên kết video TikTok cần tải?',
    a21: 'Mở ứng dụng tiktok',
