...
export default {
  home: {
    ...
    title: 'Download Video Tiktok Tanpa Watermark - TikTok Downloader - My-Tik-Taki',
    languages: 'Languages',
    ...
    text4: 'Features',
    feature1:
      'Mendownload video TikTok tanpa watermark: My-Tik-Taki.com memungkinkan Anda untuk mengunduh video TikTok tanpa watermark, sehingga mudah untuk menyimpan dan berbagi video tanpa gangguan.',
    feature2:
    ...
    feature3:
      'Tidak memerlukan software tambahan: My-Tik-Taki.com adalah aplikasi berbasis web, sehingga Anda tidak perlu menginstal software tambahan di komputer atau ponsel Anda.',
    feature4:
    ...
    feature5:
      'Gratis selamanya: My-Tik-Taki.com sepenuhnya gratis digunakan, dan tidak ada biaya atau biaya tersembunyi. Anda dapat mengunduh sebanyak video yang Anda inginkan tanpa batasan.',
    note: 'Catatan:',
    noteContent:
      'My-Tik-Taki adalah platform independen yang tidak berafiliasi dengan Tiktok atau ByteDance Ltd. Platform kami dirancang untuk menyediakan cara mudah bagi pengguna Tiktok untuk mengunduh video tanpa tanda air atau logo. Kami berkomitmen untuk memberikan pengalaman pengguna terbaik dan terus memperbarui layanan kami untuk memastikan pengunduhan yang mudah dan efisien. Jika Anda pernah mengalami masalah dengan situs lain seperti Tikmate atau SSSTiktok, cobalah My-Tik-Taki. Platform kami selalu gratis untuk digunakan dan kami mengandalkan iklan untuk mendukung pemeliharaan dan pengembangan layanan kami. Terima kasih telah memilih My-Tik-Taki untuk pengunduhan video Tiktok Anda.',
    contact: 'Kontak',
    terms: 'Syarat dan Ketentuan Layanan',
    privacy: 'Kebijakan Privasi',
    howToUse: {
      title: 'Cara Menggunakan',
      step1: 'Temukan video TikTok yang ingin Anda unduh.',
      step2: 'Salin tautan video.',
      step3: 'Tempel tautan video TikTok ke dalam kotak unduhan situs web.',
      step4: 'Klik tombol "Unduh".',
      step5: 'Tunggu situs web memproses video dan menghapus watermark.',
      step6: 'Unduh video ke perangkat Anda.',
    },
  },
  meta: {
    title: 'Download Video Tiktok Tanpa Watermark - TikTok Downloader - My-Tik-Taki',
    itemprop: 'Download Video Tiktok Tanpa Watermark - TikTok Downloader - My-Tik-Taki',
    description:
      'TikTok Video Downloader - My-Tik-Taki.com adalah salah satu alat Download video Tiktok tanpa Watermark terbaik yang tersedia secara gratis online. Anda dapat mengunduh video TikTok dari perangkat apa pun yang Anda miliki.',
    twitterTitle: 'Download Video Tiktok Tanpa Watermark - TikTok Downloader - My-Tik-Taki',
    twitterDescription:
      'TikTok Video Downloader - My-Tik-Taki.com adalah salah satu alat Download video Tiktok tanpa Watermark terbaik yang tersedia secara gratis online. Anda dapat mengunduh video TikTok dari perangkat apa pun yang Anda miliki.',
    ogTitle: 'Download Video Tiktok Tanpa Watermark - TikTok Downloader - My-Tik-Taki',
    ogDescription:
      'TikTok Video Downloader - My-Tik-Taki.com adalah salah satu alat Download video Tiktok tanpa Watermark terbaik yang tersedia secara gratis online. Anda dapat mengunduh video TikTok dari perangkat apa pun yang Anda miliki.',
    ogSiteName: 'Download Video Tiktok Tanpa Watermark - TikTok Downloader - My-Tik-Taki',
  },
  contact: {
    short: 'Contact',
    title: 'Kontak - TikTok Downloader - Unduh Video TikTok Tanpa Tanda Air - My-Tik-Taki',
    description1: 'Untuk menghubungi My-Tik-Taki.com, Anda dapat mengirim email ke ',
    description2:
  ...
  privacy: {
    ...
    title:
      'Syarat dan Ketentuan Layanan - TikTok Downloader - Unduh Video TikTok Tanpa Tanda Air - My-Tik-Taki',
  ...
  errors: {
    HAVE_ERROR:
      "Maaf, kami mengalami masalah. Harap coba lagi nanti. Terima kasih atas kesabarannya.'",
    NOT_A_LINK_TIKTOK:
      "Maaf, URL yang diberikan bukan URL TikTok yang valid. Harap berikan URL TikTok yang valid untuk melanjutkan.'",
  },
  form: {
  ...
  questions: {
    ...
    a16: 'Kembali ke My-Tik-Taki.com dan tempelkan tautan unduhan Anda ke bidang di atas lalu klik tombol Unduh.',
